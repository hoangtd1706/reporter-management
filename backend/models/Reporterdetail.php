 ...
 * @property string $rep_dob
 * @property string|null $rep_dan_toc
 * @property string|null $rep_que_quan
 ...
 * @property Organization $repCoQuan
 */
class Reporterdetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['rep_co_quan', 'rep_gender', 'rep_ngay_cap_cmnd', 'created_at', 'updated_at'], 'integer'],
            [['rep_dob'], 'safe'],
            ...
            [['rep_dan_toc'], 'string', 'max' => 30],
            [['rep_que_quan'], 'string', 'max' => 150],
            [['rep_code'], 'exist', 'skipOnError' => true, 'targetClass' => Reporter::className(), 'targetAttribute' => ['rep_code' => 'rep_code']],
            [['rep_co_quan'], 'exist', 'skipOnError' => true, 'targetClass' => Organization::className(), 'targetAttribute' => ['rep_co_quan' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'rep_code' => 'Rep Code',
            'rep_co_quan' => 'Rep Co Quan',
            'rep_name' => 'Rep Name',
            'rep_avt' => 'Rep Avt',
            'rep_gender' => 'Rep Gender',
            'rep_dob' => 'Rep Dob',
            'rep_dan_toc' => 'Rep Dan Toc',
            'rep_que_quan' => 'Rep Que Quan',
            'rep_noi_o' => 'Rep Noi O',
    ...
    /**
     * Gets query for [[RepCoQuan]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getRepCoQuan()
    {
        return $this->hasOne(Organization::className(), ['id' => 'rep_co_quan']);
    }
}
